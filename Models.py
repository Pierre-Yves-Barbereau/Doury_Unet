...
class UNet_Doury(nn.Module):
    def __init__(self, in_channels, out_channels, bilinear=False):
        super(UNet_Doury, self).__init__()
        self.in_channels = in_channels
        self.out_channels = out_channels
        self.bilinear = bilinear

        self.inconv = part.DoubleConv(in_channels, 64)
        ...
        self.dcupdc1 = part.updc(64, 64)
        self.dcupdc2 = part.updc(64, 64)
        self.dcupdcout = part.updcout(64, 64)
        self.outconv=part.OutConv(64, 1)
